...
class PaymentManager:
   ...
   def reject_payment(self, payment_id, reason=""):
    ...
    print(f"🔍 DEBUG: reject_payment çağrıldı")
    ...
    try:
        with get_connection() as conn:
            ...
            print(f"✅ Ödeme bulundu:")
            print(f"   - Email: {user_email}")
            print(f"   - Ref: {payment_ref}")
            print(f"   - Tutar: {amount}₺")
        ...
        try:
            ...
            if email_result:
                print(f"✅ Email başarıyla gönderildi: {user_email}")
            else:
        ...
        print(f"❌ KRITIK HATA: Ödeme reddetme hatası")
        print(f"   Hata: {e}")
        import traceback
        traceback.print_exc()
        return {"success": False, "error": str(e)}
